...
function Peao(cor){
    ...
    var validaMovimentoCor = function(posicaoInicial, posicaoFinal){
        var mesmoY = posicaoFinal[Y] === posicaoInicial[Y];
        var validoX;
        if(this.cor === Cor.BRANCA){
            validoX = (posicaoFinal[X] - posicaoInicial[X] === 1);
        } else {
            validoX = (posicaoFinal[X] + posicaoInicial[X] === 1);
        }
        return validoX && mesmoY;
    };

    this.move = function(posicaoInicial, posicaoFinal, jogo){
        var validoParaFrente = validaMovimentoCor(posicaoInicial, posicaoFinal);
